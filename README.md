...
**Dla kogo:** marketing manager, developer, student, produktowiec – każdy, kto pracuje z AI (Antigravity, Claude, Gemini CLI, Cursor, Codex, OpenHand) i chce, aby system natychmiast rozumiał jego styl pracy oraz porządkował wiedzę i zadania lokalnie.
...
Pobierz i zainstaluj szablon zgodnie z pełną instrukcją krok po kroku w pliku [`INSTALL.md`](./INSTALL.md).
