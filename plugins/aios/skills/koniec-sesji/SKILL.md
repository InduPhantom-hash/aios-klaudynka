---
name: koniec-sesji
description: Zamkniecie sesji AIOS - zapisuje transkrypt do _brudnopis/, aktualizuje _pamiec/aktualny.md i opcjonalnie DREAM.md. Uzywaj zawsze gdy konczysz prace i chcesz zachowac kontekst. Triggery - "/koniec-sesji", "koniec sesji", "zapisz stan", "konczymy prace", "zamknij sesje", "zapisz sesje".
---

# AIOS: Koniec sesji

Zamykasz sesję z użytkownikiem. Vault to system - twoje zadanie to zostawić go w stanie gotowym do następnej sesji z dowolnym AI.

## Krok 1: Zapytaj o metadane

Zanim cokolwiek zapiszesz, zapytaj użytkownika o **jedną rzecz**:

> "Tryb tej sesji: eksploracja czy skupienie? Projekt: [zgadnij z kontekstu] - ok?"

Jeśli użytkownik potwierdza lub koryguje - masz wszystko do frontmatter.
...
Treść: pełna rozmowa verbatim od początku sesji. Oznacz wypowiedzi `**Użytkownik:**` / `**AI:**`. Nie kompresuj - historia myślenia jest wartościowa.
...
<tylko rzeczy wyraźnie zatwierdzone przez użytkownika>
...
4. **Pokaż diff użytkownikowi i czekaj na "tak"** - DREAM to fundament systemu
...
Jednolinijkowy, np.:
```
Sesja zapisana: _brudnopis/2026-04-19-aios-skille-setup.md | aktualny.md zaktualizowany | DREAM: pominięty | Następnym razem: dokończyć Wiki projektu X
```

## Kiedy pominąć ten skill

- Sesja krótsza niż 5 minut i nic znaczącego
- Użytkownik explicite: "nie zapisuj tego"
