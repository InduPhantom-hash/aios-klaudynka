...
Nazwa indexu, model embeddingu i namespace'y pochodza z TWOJEJ konfiguracji (ustalonej w `/aios:init`,
Sekcja E + FIN4). Wartosci ponizej (`index "aios"`, model `multilingual-e5-large`, pole `text`,
mapa namespace) to **przyklad domyslny** - podmien na to, co masz w swoim indeksie.
...
namespace: zaleznie od klasyfikacji (PRZYKLAD - dostosuj do kategorii z TWOJEGO me.md / vault-map):
  - Wiedza/AI/*          -> "wiedza-ai"
...
2. Projekty/Vibe-coding/moja-apka/notes/karpathy-inspiration.md
